...
copy_with_header() {
    ...
    if [ -f "$source_file" ]; then
        ...
        local filepath=$(echo "$source_file" | sed 's|^\./||')
...
copy_with_header \
    "app/admin/settings/media/page.tsx" \
...
copy_with_header \
    "app/api/admin/database/backups/route.ts" \
